    ...
    <div className="bg-gray-900/50 backdrop-blur-lg rounded-xl border border-gray-700/50 p-6">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
          <h3 className="text-blue-300 font-medium text-sm mb-2">Current Tag</h3>
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Use lowercase letters and hyphens. Spaces will be converted to hyphens automatically.
          </p>
        </div>
        ...
        {formData.name !== currentTag && (
          <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
            <h3 className="text-yellow-300 font-medium text-sm mb-2">⚠️ Important</h3>
            <p className="text-yellow-200/80 text-sm">
              Changing the tag name will update all prompts that currently use the tag "{currentTag}" to use "{formData.name}" instead.
            </p>
          </div>
        )}
        ...
        <div className="flex items-center justify-between pt-6 border-t border-gray-700">
          ...
          <button
            type="submit"
            disabled={isLoading || !formData.name.trim() || formData.name === currentTag}
