      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Public prompts can be viewed by anyone. Private prompts are only visible to you.
          </p>
        </div>
