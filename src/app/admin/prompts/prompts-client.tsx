...
import { deletePrompt, bulkDeletePrompts, bulkUpdatePrompts, type Prompt } from '@/app/actions/admin'
...
export default function PromptsClient({ 
  ...
  const handleBulkDelete = async () => {
    if (!confirm(`Are you sure you want to delete ${selectedPrompts.length} prompts?`)) return
          ...
          <table className="min-w-full divide-y divide-gray-800">
            ...
            <tbody className="bg-gray-900 divide-y divide-gray-800">
              {prompts.length === 0 ? (
                ...
                prompts.map((prompt) => (
                  <tr key={prompt.id} className="hover:bg-gray-800">
